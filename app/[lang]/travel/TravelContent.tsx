...
import {
  Plane, MapPin, Star, Phone, CheckCircle2, Calendar, Globe, Compass, Ticket, Users,
  Clock, Shield
} from 'lucide-react';
  ...
  en: {
    ...
    services: [
      ...
      },
      {
        ...
        desc: 'Practical guidance on entry requirements, paperwork, and trip planning.',
        items: ['Entry requirements', 'Document checklists', 'Travel insurance info', 'Travel advisories'],
      },
      {
        title: 'Group Travel',
  ...
  sq: {
    ...
    services: [
      ...
      },
      {
        ...
        items: ['Kërkesat e hyrjes', 'Lista dokumentesh', 'Info sigurim udhëtimi', 'Këshilla udhëtimi'],
      },
      {
        title: 'Udhëtim Grupi',
      ...
      <section className="py-14 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-slate-600 text-sm">
            ...
            <Link href={path('/contact')} className="text-brand-red hover:underline font-medium">{c.routesNoteLink}</Link>{' '}
            {c.routesNoteEnd}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button asChild size="lg" variant="default">
              <Link href={path('/contact#booking')}><Calendar className="w-4 h-4" /> {c.ctaBook}</Link>
            </Button>
